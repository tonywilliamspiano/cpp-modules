...
/*   Updated: 2024/08/12 17:14:35 by awilliam         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
AForm::AForm(const AForm &rhs)
        : _name(rhs.getName()), _gradeRequiredToSign(rhs.getSignGrade()),
          _gradeRequiredToExecute(rhs.getExecuteGrade()) {
...
std::ostream &operator<<(std::ostream &stream, const AForm &instance) {
    ...
    stream << "Is the form signed? " << (instance.getSignedStatus() ? "Yes :)" : "No :(") << std::endl;
